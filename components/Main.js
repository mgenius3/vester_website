    ...
    <section className="text-gray-600 body-font">
      <div className="container mx-auto flex mt-20 pt-10 md:flex-row md:justify-center items-center flex-col md:border-b border-gray-400 mb-10">
        <div className="md:w-1/2 mx-3">
          <h1 className="mb-5 sm:text-4xl text-4xl sm:text-4xl text-red-900 Avenir xl:w-2/2">
            Efficient Transport and Logistics
          </h1>
          <p className="mb-4 text-lg text-gray-600 ">
            Vester Efficient Transport and Logistics is your trusted partner for
          ...
          <div className="flex sm:flex-row flex-col items-center  md:block hidden">
            <a
              ...
              href="https://play.google.com/store/apps/details?id=com.logistics.vester"
            >
        ...
        <div className="flex md:flex-row flex-col-reverse items-center ">
          <div className="md:w-1/2 container px-5">
            ...
            <div className="flex md:hidden block my-3">
              <Link href="https://vester.vercel.app/driver/login">
                <p
                  className="
             bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline-red active:bg-red-800 cursor-pointer
                 "
                >
                  Get Started
                </p>
